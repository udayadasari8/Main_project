...
window.configure(background='royalblue')
...
def manually_fill():
    ...
    sb.geometry('580x320')
    sb.configure(background='royalblue')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            PH = tk.Label(MFW, text="Enter Mobile Number", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
            PH.place(x=30, y=300)
            ...
            c1ear_PH = tk.Button(MFW, text="Clear", command=remove_PH, fg="white", bg="black", width=10,
                                      height=1,
                                      activebackground="white", font=('times', 15, ' bold '))
            c1ear_PH.place(x=690, y=300)
...
def err_screen():
    ...
    Label(sc1, text='Enrollment ,NAame& Phone Number required!!!', fg='black',
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            Time = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
            row = [Enrollment, Name, PHONE,Date, Time]
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                col_names = ['Enrollment', 'Name','Phone', 'Date', 'Time']
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if (conf < 70):
                            ...
                            phone = df.loc[df['Enrollment'] == Id]['Phone'].values
                            print(aa)
                            print(phone)
                            print(Id)
                            global tt
...
message = tk.Label(window, text="FaceFusion Register", bg="black", fg="white", width=50,
...
lbl3 = tk.Label(window, text="Enter Phone Number : ", width=20, fg="black",
                bg="grey", height=2, font=('times', 15, ' bold '))
lbl3.place(x=200, y=400)

txt3 = tk.Entry(window, validate="key", width=20, bg="white",
                fg="black", font=('times', 25))
